...
most.gained <- pulitzer %>% filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 == 
...
pulitzer.5.decrease <- pulitzer %>% filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 >= 5, 
